...
#define MT29FG01AAAED
	...
	/* utility macros */
	#define ADDRESS_2_BLOCK(Address)	((NMX_uint16) ((Address >> 18) & 0x07FF))
 ...
 *
 * ECC status bits (SR6,SR5,SR4) should be interpreted as follow:
 *
 * 000 = no errors;
 * 001 = 1-3 bit error corrected;
 * 010 = > 8 bit errors not corrected;
 * 011 = 4-6 bit errors corrected;
 * 101 = 7-8 bit errors corrected - data refreshment req;
 */
...
typedef enum
{
	...
	SPI_NAND_DIESLCT_REG_ADDR	= 0xD0,
} Register;
